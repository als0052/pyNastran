...
# inheritance diagram should have size determined by graphviz with layout 
# from top to bottom (default is left to right)
...
# further. For a list of options available for each theme, see documentation.
# html_theme_options = {}
