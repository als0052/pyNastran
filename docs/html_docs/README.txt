...
2.  >>> pip install -r requirements_docs.txt
...
# this one is done with a script that can be customized b/c I don't know how 
# to create the original
#
# note this script also deletes folders in order to prevent unwanted 
# files/directories from being made into html
#
# This isn't really a big deal since this we have git.
python makeIndex.py
